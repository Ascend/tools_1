...
def check_nonnegative_integer_upto255(value):
    ivalue = int(value)
...
def get_args():
    ...
    parser.add_argument("--device", "--device", type=check_nonnegative_integer_upto255, default=0, help="the NPU device ID to use")
