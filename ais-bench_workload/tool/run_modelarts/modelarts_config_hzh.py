...
session_config = ed({
    ...
    # obs代码路径 程序会自动拷贝到该路径
    'code_dir': '/0923/000_hzh_bert/full/',
    # 启动文件 必须要在code_dir路径下，请按样例格式填写
    'boot_file': '/0923/000_hzh_bert/full/run_pretrain.py',

    # 如下为运行相关参数
    # job名称  如果云环境Modelarts服务训练作业job队列中没有，则会新建一个job；若和已有job同名，则会在该job中，新建测试实例.
    'job_name': "trainjob-bert_test",
    ...
    "out_base_url": "/0923/res/bert_test",
    # job 描述前缀
    "job_description_prefix": 'trainjob-bert_test from sdk',
})